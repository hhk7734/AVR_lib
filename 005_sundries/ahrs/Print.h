...
public:
    ...
    inline void println( uint16_t data )
    {
        print( data );
        println();
    }
    inline void println( int16_t data )
    {
        print( data );
        println();
    }
    inline void println( uint32_t data )
    {
        print( data );
        println();
    }
    inline void println( int32_t data )
    {
        print( data );
        println();
    }
    inline void println( uint64_t data )
    {
        print( data );
        println();
    }
    inline void println( int64_t data )
    {
        print( data );
        println();
    }
    inline void println( float data, int digits = 2 )
    {
        print( data, digits );
        println();
    }
    inline void println( double data, int digits = 2 )
    {
        print( data, digits );
        println();
    }
